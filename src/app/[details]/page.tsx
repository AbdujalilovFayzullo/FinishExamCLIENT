...
import Poter from '../../assets/images/poter.png'
import Poter1 from '../../assets/images/poter-one.png'
...
const Details = ({params}: {
    ...
    const getproduct = async () => {
        try {
            const res = await axios.get(`https://65c17151dc74300bce8da4c7.mockapi.io/products?id=${details}`)
